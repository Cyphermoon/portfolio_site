...
const Background = ({ children, addAnimation }: backgroundType) => {
    ...
    return (
        <div className={`w-screen min-h-screen overflow-hidden bg-slate-100 dark:bg-slate-900 text-gray-800 dark:text-slate-400 transition-colors duration-200 pb-10`}>
