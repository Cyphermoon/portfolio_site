...
const SmallProjectCard = ({ imageURL, description, title, projectId }: projectCardType) => {
    return (
        ...
        <Link href={`/project/${encodeURIComponent(projectId)}`} >
            <div className='
                py-3 relative cursor-pointer h-[200px] rounded-2xl before-h-full 
                ...
                md:dark:before:opacity-[0.85] dark:bg-slate-800
            ...
            >
                ...
                <div className="absolute top-3 left-3 z-10 transition-opacity duration-500 text-gray-100 dark:text-slate-300 dark:group-hover:opacity-0">
