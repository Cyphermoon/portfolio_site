        ...
        <div className='w-screen overflow-hidden bg-slate-100 dark:bg-slate-900 text-gray-800: dark:text-slate-400 pb-10'>
            ...
            <Container className='space-y-12'>
                ...
                <main className='space-y-10 flex flex-col '>
                    ...
                    <div className='dark:bg-slate-600 py-6 px-4 rounded-xl flex flex-col start space-y-12'>
                        <Menu as={"div"} className="self-end w-max relative">
                            <Menu.Button
                                className="w-full text-slate-50 bg-blue-500 dark:bg-slate-900 rounded-lg capitalize p-2 inline-flex justify-between items-center space-x-2 text-md">
                                <span>category</span>
                                <IoIosArrowDown />
                            </Menu.Button>
                            <Transition
