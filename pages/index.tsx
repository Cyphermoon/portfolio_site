      ...
      <Container>
        <Header >
          <div className="w-full md:w-9/12 text-center space-y-9 flex flex-col">
            <h1 className="text-[2.75rem] md:text-5xl  lg:text-display_lg font-bold text-center">My name is kelvin, i am a<span className="text-blue-500"> frontend developer</span></h1>
